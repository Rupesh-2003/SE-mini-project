                ...
                :
                    <>
                        <div className='flex flex-row items-center gap-x-[30px] mr-[30px] cursor-pointer'>
                            <div className={`hover:text-purple-dark hover:font-medium ${pathname == "/aiSolutions" && "text-purple-dark"}`} onClick={() => {router.push("/aiSolutions")}}>AI Solutions</div>
                            {/* <div className={`hover:text-purple-dark hover:font-medium ${pathname == "/ayurlearn/modules" && "text-purple-dark"}`} onClick={() => {router.push("/ayurlearn/modules")}}>Ayurvedic Learning</div> */}
                            {/* <div className={`hover:text-purple-dark hover:font-medium`}>Talk to Expert</div> */}
                        </div>
